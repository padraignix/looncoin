...
#if defined(NDEBUG)
# error "Looncoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Looncoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LOON additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("looncoin-scriptch");
...
static bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const CChainParams& params, const CBlockIndex* pindexPrev, int64_t nAdjustedTime)
{
    ...
    /*
         Looncoin <= 0.10.0.2 has a bug left behind from years ago where it never rejected old nVersion numbers
