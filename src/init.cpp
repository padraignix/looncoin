 ...
 * between looncoind, and looncoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/looncoin/looncoin>";
    const std::string URL_WEBSITE = "<https://looncoin.org>";
...
/** Sanity checks
 *  Ensure that Looncoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Looncoin process is using the data directory.
